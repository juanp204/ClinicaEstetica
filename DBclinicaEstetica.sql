...
CREATE USER 'clinicaestetica'@'%' IDENTIFIED BY 'clinicaestetica';
GRANT ALL PRIVILEGES ON *.* TO 'clinicaestetica'@'%';
FLUSH PRIVILEGES;
...
insert into tipocita(servicio)
values ('Lipoescultura'),('Addominoplastia'),('Blefaroplasta'),('Rinoplastia'),('Aumento de Glúteos'),('Tratamiento contra las estrias'),('Bótox'),('Disminución de ojeras')
